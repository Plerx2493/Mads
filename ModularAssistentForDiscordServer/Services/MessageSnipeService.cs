...
public class MessageSnipeService : IHostedService
{
    ...
    private readonly DiscordCommandService _discordCommandService;
    private DiscordClient Discord => _discordCommandService.DiscordClient;
    
    private static ILogger _logger = Log.ForContext<MessageSnipeService>();
    
    public MessageSnipeService(IMemoryCache memoryCache, DiscordCommandService discordCommandService)
    {
